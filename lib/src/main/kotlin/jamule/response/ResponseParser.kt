...
import jamule.ec.ECTagName.EC_TAG_PASSWD_SALT
...
class ResponseParser(
    ...
    fun parse(packet: Packet): Response = when (packet.opCode) {
        ...
        ECOpCode.EC_OP_AUTH_SALT -> AuthResponse(packet.long(EC_TAG_PASSWD_SALT).getValue())
